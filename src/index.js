...
class JMeterReportAnalyzer {
    constructor(searchLocation, outputPath, selectionMode = 'b', threshold = 1000, argumentLabel = '1 TPS') {
...
<body>
  <div id="root">
    ...
    <div>Response Time at 95 percentile Under ${this.argumentLabel}: ${pct95} ms</div>
    ...
    async run(folderName) {
        ...
        console.log(`95th percentile label: ${this.argumentLabel}`);
...
async function main() {
    ...
    program
        ...
        .option('--label <label>', 'Label used in the 95th percentile message', '1 TPS');
